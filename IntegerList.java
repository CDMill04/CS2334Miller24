...
public class IntegerList {
	 ...
	 */
	public void add(int integer) throws IndexOutOfBoundsException {
		try {
			insert(size, integer);
			joiner.add(String.valueOf(integer));
		}
		catch (IndexOutOfBoundsException e){
			String message = "The index is outside the range [" + array[0] +", " + array[size - 1] + "]";
	 ...
	 *                                    or equal to size
	 */
	public int get(int index) throws IndexOutOfBoundsException{ //Will have to edit this depending on expected outcome
	...
	public String toString() {
		//StringJoiner joiner = new StringJoiner(", ", "[", "]");
		String endResult = joiner.toString();
		return endResult;
	}
}
